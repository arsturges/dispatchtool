...
RESULTS_DOWNLOAD_FOLDER = os.path.join(parent_directory_to_this_file, 'user_results')
TEMPLATES_DOWNLOAD_FOLDER = os.path.join(parent_directory_to_this_file, 'csv_templates')
